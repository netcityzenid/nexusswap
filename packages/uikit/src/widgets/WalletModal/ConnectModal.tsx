...
const ConnectModal: React.FC<Props> = ({ login, onDismiss = () => null, displayCount = 3, t }) => {
  ...
  return (
    <ModalContainer minWidth="320px">
      <ModalHeader background="#ffae36">
        <ModalTitle>
          <Heading textAlign="center" color="white" as="p" mb="16px">{t("Connect Wallet")}</Heading>
        </ModalTitle>
        <ModalCloseButton onDismiss={onDismiss} color="white" />
      </ModalHeader>
      <ModalBody background="#54a4ff" width={["320px", null, "340px"]}>
        ...
        <Box color="#ffae36" p="24px">
          <Text textAlign="center" color="white" as="p" mb="16px">
